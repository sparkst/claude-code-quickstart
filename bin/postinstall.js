...
(async () => {
  ...
  console.log('This will configure global settings (~/.claude/settings.json) and can scaffold project files.');
  ...
  rl.close();
  const r = spawnSync(process.execPath, [require.resolve('./cli.js')], { stdio: 'inherit' });
